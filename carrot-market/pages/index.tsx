  ...
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <button
          className="mt-5 dark:bg-black dark:border-white dark:border
        bg-blue-500 text-white p-3 text-center rounded-xl w-3/4 block mx-auto
        dark:hover:bg-white hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500 "
        >
          Checkout
        </button>
      </div>
