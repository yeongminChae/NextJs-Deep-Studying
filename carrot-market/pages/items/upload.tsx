...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-16">
      ...
      <button className="mt-4 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-3 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none ">
        Upload product
      </button>
    </div>
  );
