    ...
    <Layout canGoBack>
      <div className="px-4 py-10">
        <div className="mb-8">
          ...
          <div className="py-3 cursor-pointer border-t border-b flex items-center space-x-3">
            <div className="w-12 h-12 rounded-full bg-slate-300" />
            <div>
              <p className="text-sm font-medium text-gray-700">Steve Jebs</p>{" "}
              <Link href="/profile">
                <p className="text-xs font-medium cursor-pointer text-gray-500">
                  View profile &rarr;
                </p>
              </Link>
            </div>
          ...
          <div className="mt-10">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white py-3 rounded-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-medium ">
                Talk to seller
              </button>
